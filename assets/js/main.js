...
tabs.forEach((tab) => {
  tab.addEventListener("click", () => {
    ...
    tabContents.forEach((tc) => {
      tc.classList.remove("filters-sections-active");
    }),
      target.classList.add("filters-sections-active");
...
if (selectedTheme) {
  ...
  themeButton.classList[selectedIcon === "ri-toggle-line" ? "add" : "remove"](
    iconTheme
  );
}
...
sr.reveal(".theme-button", { delay: 500 });
...
sr.reveal(".filters-container", { delay: 1000 });
